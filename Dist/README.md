...
Runtime distribution files for the ge-next32 module live here.

Contents include:
- `MPOGEMP.MDF` module definition
- `MPOGEMSG.MSG`, `MPOGEHLP.MSG`, and `MPOGESHP.MSG` message/config files
